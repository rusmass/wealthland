...
public class HttpRequestUtil {
    ...
    public static final String CHARSET = "UTF-8";    //设置格式
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        params.put("type", "pt");
        params.put("mobile", "18618399063");
        params.put("content", "【智富人生】短信验证码为：" + 1234 + "。一分钟内有效，请不要把验证码泄露给其他人。");
        String checkVersion = doPost("http://web.cr6868.com/asmx/smsservice.aspx", params);
